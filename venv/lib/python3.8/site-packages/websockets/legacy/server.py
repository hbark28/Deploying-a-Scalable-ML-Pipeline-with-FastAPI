...
HeadersLikeOrCallable = Union[HeadersLike,
                              Callable[[str, Headers], HeadersLike]]
...
class WebSocketServerProtocol(WebSocketCommonProtocol):
    ...
    def __init__(
        ...
        ws_handler: Union[
            ...
            Callable[[WebSocketServerProtocol, str],
                     Awaitable[Any]],  # deprecated
        ],
        ...
        **kwargs: Any,
        ...
        if origins is not None and "" in origins:
            warnings.warn("use None instead of '' in origins",
                          DeprecationWarning)
    ...
    async def read_http_request(self) -> Tuple[str, Headers]:
        ...
        try:
            ...
            raise InvalidMessage(
                "did not receive a valid HTTP request") from exc
    ...
    def process_origin(
        ...
        try:
            ...
            raise InvalidHeader(
                "Origin", "more than one Origin header found") from exc
    ...
    def select_subprotocol(
        ...
        return sorted(
            subprotocols,
            key=lambda p: client_subprotocols.index(
                p) + server_subprotocols.index(p),
        )[0]
    ...
    async def handshake(
        ...
        if isinstance(early_response_awaitable, Awaitable):
            ...
            # For backwards compatibility with 7.0.
            warnings.warn("declare process_request as a coroutine",
                          DeprecationWarning)
...
class Serve:
    ...
    * You can set ``sock`` to a :obj:`~socket.socket` that you created
    ...
    def __init__(
        ...
        *,
        create_protocol: Optional[Callable[...,
        ...
        **kwargs: Any,
        ...
        if timeout is None:
            ...
            warnings.warn("rename timeout to close_timeout",
                          DeprecationWarning)
        ...
        klass: Optional[Type[WebSocketServerProtocol]
                        ] = kwargs.pop("klass", None)
        if klass is None:
            klass = WebSocketServerProtocol
        else:
            warnings.warn("rename klass to create_protocol",
                          DeprecationWarning)
