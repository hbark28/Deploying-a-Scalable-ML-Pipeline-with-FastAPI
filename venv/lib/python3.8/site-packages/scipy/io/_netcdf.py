    ...
    def _write_dim_array(self):
        if self.dimensions:
            ...
            for name in self._dims:
                ...
                # replace None with 0 for record dimension
        ...
        if not var.isrec:
            ...
            if self._recs > len(var.data):
                ...
                try:
                    ...
                    var.__dict__['data'] = np.resize(
                        var.data, shape).astype(var.data.dtype)
    ...
    def _read_var_array(self):
        ...
        for var in range(count):
            ...
            if shape and shape[0] is None:  # record variable
                ...
                if self.use_mmap:
                    data = self._mm_buf[begin_:begin_ +
        ...
        if rec_vars:
            ...
            # Build rec array.
            if self.use_mmap:
                rec_array = self._mm_buf[begin:begin +
                                         self._recs*self._recsize].view(dtype=dtypes)
