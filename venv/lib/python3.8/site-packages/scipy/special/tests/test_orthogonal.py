...
class _test_sh_jacobi:
    def test_sh_jacobi(self):
        ...
        def conv(n, p): return gamma(n+1)*gamma(n+p)/gamma(2*n+p)
        psub = np.poly1d([2, -1])
...
def test_roots_jacobi():
    def rf(a, b): return lambda n, mu: sc.roots_jacobi(n, a, b, mu)
    def ef(a, b): return lambda n, x: sc.eval_jacobi(n, a, b, x)
    def wf(a, b): return lambda x: (1 - x)**a * (1 + x)**b
...
def test_roots_sh_jacobi():
    def rf(a, b): return lambda n, mu: sc.roots_sh_jacobi(n, a, b, mu)
    def ef(a, b): return lambda n, x: sc.eval_sh_jacobi(n, a, b, x)
    def wf(a, b): return lambda x: (1. - x)**(a - b) * (x)**(b - 1.)
...
def test_roots_gegenbauer():
    def rootf(a): return lambda n, mu: sc.roots_gegenbauer(n, a, mu)
    def evalf(a): return lambda n, x: sc.eval_gegenbauer(n, a, x)
    def weightf(a): return lambda x: (1 - x**2)**(a - 0.5)
...
def test_roots_chebyt():
    ...
    verify_gauss_quad(sc.roots_chebyt, sc.eval_chebyt,
                      weightf, -1., 1., 100, atol=1e-12)
...
def test_roots_chebyc():
    ...
    verify_gauss_quad(sc.roots_chebyc, sc.eval_chebyc,
                      weightf, -2., 2., 100, atol=1e-12)
...
def test_roots_sh_chebyt():
    ...
    verify_gauss_quad(sc.roots_sh_chebyt,
                      sc.eval_sh_chebyt, weightf, 0., 1., 5)
    verify_gauss_quad(sc.roots_sh_chebyt, sc.eval_sh_chebyt,
                      weightf, 0., 1., 25)
...
def test_roots_sh_chebyu():
    ...
    verify_gauss_quad(sc.roots_sh_chebyu,
                      sc.eval_sh_chebyu, weightf, 0., 1., 5)
    verify_gauss_quad(sc.roots_sh_chebyu, sc.eval_sh_chebyu,
                      weightf, 0., 1., 25)
...
def test_roots_sh_legendre():
    ...
    verify_gauss_quad(sc.roots_sh_legendre,
                      sc.eval_sh_legendre, weightf, 0., 1., 5)
...
def test_roots_laguerre():
    ...
    verify_gauss_quad(sc.roots_laguerre, sc.eval_laguerre,
                      weightf, 0., np.inf, 5)
...
def test_roots_genlaguerre():
    def rootf(a): return lambda n, mu: sc.roots_genlaguerre(n, a, mu)
    def evalf(a): return lambda n, x: sc.eval_genlaguerre(n, a, x)
    def weightf(a): return lambda x: x**a * np.exp(-x)
    ...
    vgq(rootf(50), evalf(50), weightf(50), 0.,
        np.inf, 100, rtol=1e-14, atol=2e-13)
