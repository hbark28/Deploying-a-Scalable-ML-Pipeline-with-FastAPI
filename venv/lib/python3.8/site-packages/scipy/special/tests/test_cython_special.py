...
PARAMS: List[Tuple[Callable, Callable, Tuple[str, ...], Optional[str]]] = [
    ...
    (special.spherical_jn, cython_special.spherical_jn,
     ('ld', 'ldb', 'lD', 'lDb'), None),
    (special.spherical_yn, cython_special.spherical_yn,
     ('ld', 'ldb', 'lD', 'lDb'), None),
    (special.spherical_in, cython_special.spherical_in,
     ('ld', 'ldb', 'lD', 'lDb'), None),
    (special.spherical_kn, cython_special.spherical_kn,
     ('ld', 'ldb', 'lD', 'lDb'), None),
...
def test_cython_api(param):
    ...
    for typecodes in specializations:
        ...
        for pt in pts:
            ...
            assert_allclose(cyval, pyval, err_msg="{} {} {}".format(
                pt, typecodes, signature))
