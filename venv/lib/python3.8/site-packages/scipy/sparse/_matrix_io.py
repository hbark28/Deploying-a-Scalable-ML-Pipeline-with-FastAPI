...
def save_npz(file, matrix, compressed=True):
    ...
    if matrix.format in ('csc', 'csr', 'bsr'):
        ...
        raise NotImplementedError(
            'Save is not implemented for sparse matrix of format {}.'.format(matrix.format))
    arrays_dict.update(
...
def load_npz(file):
    ...
    with np.load(file, **PICKLE_KWARGS) as loaded:
        try:
            ...
            raise ValueError(
                'The file {} does not contain a sparse matrix.'.format(file)) from e
        ...
        try:
            ...
            raise ValueError(
                'Unknown matrix format "{}"'.format(matrix_format)) from e
