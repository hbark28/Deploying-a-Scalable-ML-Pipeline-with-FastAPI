...
class bsr_matrix(_cs_matrix, _minmax_mixin):
    ...
    **Blocksize**
    ...
    def __init__(self, arg1, shape=None, dtype=None, copy=False, blocksize=None):
        ...
        if isspmatrix(arg1):
            ...
            if isshape(arg1):
                ...
                self.data = np.zeros(
                    (0,) + blocksize, getdtype(dtype, default=float))
        ...
        if shape is not None:
            ...
            if self.shape is None:
                ...
                try:
                    ...
                    raise ValueError(
                        'unable to infer matrix dimensions') from e
                else:
                    R, C = self.blocksize
    ...
    def sort_indices(self):
        ...
        bsr_sort_indices(M//R, N//C, R, C, self.indptr,
                         self.indices, self.data.ravel())
    ...
    def _binopt(self, other, op, in_shape=None, out_shape=None):
        ...
        if op in bool_ops:
            ...
            data = np.empty(
                R*C*max_bnnz, dtype=upcast(self.dtype, other.dtype))
