...
def _digammainv(y):
    ...
    def func(x): return sc.digamma(x) - y
    if y > -0.125:
        x0 = np.exp(y) + 0.5
        if y < 10:
    ...
    def fit(self, data, *args, **kwds):
        ...
        if fscale is None:
            ...
            if f0 is not None:
                ...
                def func(a): return np.log(a) - sc.digamma(a) - s
    ...
    def _rvs_scalar(self, p, b, numsamples, random_state):
        ...
        if ratio_unif:
            ...
            if mode_shift:
                ...
                def logqpdf(x): return self._logquasipdf(x, p, b) - lm
                c = m
            else:
                ...
                c = 0
                def logqpdf(x): return self._logquasipdf(x, p, b)
...
class ncf_gen(rv_continuous):
    ...
    def _munp(self, n, dfn, dfd, nc):
        val = (dfn * 1.0/dfd)**n
        term = sc.gammaln(n+0.5*dfn) + sc.gammaln(0.5 *
                                                  dfd-n) - sc.gammaln(dfd*0.5)
...
crystalball = crystalball_gen(
    name='crystalball', longname="A Crystalball Function")
