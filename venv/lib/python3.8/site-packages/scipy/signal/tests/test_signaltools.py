...
class _TestLinearFilter:
    ...
    def test_rank_3_IIR_init_cond(self):
        ...
        for axis in range(x.ndim):
            ...
            def lf0(w): return lfilter(b, a, w, zi=zi1)[0]
            def lf1(w): return lfilter(b, a, w, zi=zi1)[1]
    ...
    def test_bad_size_zi(self):
        ...
        self.base_bad_size_zi([1, 1, 1], [1], x2, 0, [
                              [0, 1, 2, 3], [4, 5, 6, 7]])
...
def test_lfilter_notimplemented_input():
    ...
    assert_raises(NotImplementedError, lfilter, [
                  2, 3], [4, 5], [1, 2, 3, 4, 5])
...
class TestCorrelateComplex:
    ...
    def test_rank1_valid(self, dt):
        ...
        y = correlate(b, a, 'valid')
        assert_array_almost_equal(
            y, y_r[::-1].conj(), decimal=self.decimal(dt))
        assert_equal(y.dtype, dt)
...
class TestCorrelate2d:
    ...
    def test_invalid_shapes(self):
        ...
        assert_raises(ValueError, signal.correlate2d,
                      *(a, b), **{'mode': 'valid'})
        assert_raises(ValueError, signal.correlate2d,
                      *(b, a), **{'mode': 'valid'})
