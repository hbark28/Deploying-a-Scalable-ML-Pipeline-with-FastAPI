    ...
    def from_prioritized_choices(
        ...
        for _iter in range(100):
            ...
            for original_defs_ref in definitions:
                ...
                json_remapping[defs_to_json[original_defs_ref]
...
class GenerateJsonSchema:
    ...
    def literal_schema(self, schema: core_schema.LiteralSchema) -> JsonSchemaValue:
        ...
        Returns:
            The generated JSON schema.
        """
        expected = [v.value if isinstance(
            ...
            for alias_path in schema['discriminator']:
                ...
                for choice in one_of_choices:
                    while '$ref' in choice:
                        ...
                        choice = self.get_schema_from_definitions(
                            JsonRef(choice['$ref'])) or {}
    ...
    def _update_class_schema(
        ...
        if '$ref' in json_schema:
            schema_to_update = self.get_schema_from_definitions(
                JsonRef(json_schema['$ref'])) or json_schema
        else:
    ...
    def dataclass_schema(self, schema: core_schema.DataclassSchema) -> JsonSchemaValue:
        ...
        if is_dataclass(cls) and not hasattr(cls, '__pydantic_validator__'):
            ...
            description = None if cls.__doc__ is None else inspect.cleandoc(
                cls.__doc__)
        if description:
    ...
    def p_arguments_schema(
        ...
        json_schema: JsonSchemaValue = {
            'type': 'array', 'prefixItems': prefix_items}
        if min_items:
