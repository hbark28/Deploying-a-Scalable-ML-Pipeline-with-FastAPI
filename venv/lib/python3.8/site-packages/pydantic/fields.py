...
class FieldInfo(_repr.Representation):
    ...
    def __init__(self, **kwargs: Unpack[_FieldInfoInputs]) -> None:
        ...
        """
        self._attributes_set = {k: v for k,
                                v in kwargs.items() if v is not _Unset}
        kwargs = {k: _DefaultValues.get(
            k) if v is _Unset else v for k, v in kwargs.items()}  # type: ignore
...
def Field(  # noqa: C901
    ...
    *,
    ...
    json_schema_extra: JsonDict | typing.Callable[[
        JsonDict], None] | None = _Unset,
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    if min_items is not None:
        warn('`min_items` is deprecated and will be removed, use `min_length` instead',
             DeprecationWarning)
    ...
    if max_items is not None:
        warn('`max_items` is deprecated and will be removed, use `max_length` instead',
             DeprecationWarning)
    ...
    if allow_mutation is not None:
        warn('`allow_mutation` is deprecated and will be removed. use `frozen` instead',
             DeprecationWarning)
...
def computed_field(
    ...
    *,
    ...
    def dec(f: Any) -> Any:
        ...
        if repr is None:
            repr_: bool = False if _wrapped_property_is_private(
                property_=f) else True
        else:
            repr_ = repr
