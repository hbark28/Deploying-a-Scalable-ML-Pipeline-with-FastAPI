    ...
    **Note:** `TypeAdapter` instances are not types, and cannot be used as type annotations for fields.
        ...
        *,
        ...
        try:
            ...
            validator = create_schema_validator(
                core_schema, type, module, str(
                    type), 'TypeAdapter', core_config, config_wrapper.plugin_settings
            )  # type: ignore
    ...
    def json_schemas(
        ...
        *,
        ...
        inputs = [(key, mode, adapter.core_schema)
                  for key, mode, adapter in __inputs]
