...
RedisDsn = Annotated[
    Url,
    UrlConstraints(allowed_schemes=[
                   'redis', 'rediss'], default_host='localhost', default_port=6379, default_path='/0'),
]
...
"""
MongoDsn = Annotated[MultiHostUrl, UrlConstraints(
...
"""
KafkaDsn = Annotated[Url, UrlConstraints(
...
"""
NatsDsn = Annotated[
    MultiHostUrl, UrlConstraints(allowed_schemes=[
                                 'nats', 'tls', 'ws'], default_host='localhost', default_port=4222)
]
...
class NameEmail(_repr.Representation):
    ...
    def _validate(cls, __input_value: NameEmail | str) -> NameEmail:
        if isinstance(__input_value, cls):
            ...
            name, email = validate_email(
                __input_value)  # type: ignore[arg-type]
