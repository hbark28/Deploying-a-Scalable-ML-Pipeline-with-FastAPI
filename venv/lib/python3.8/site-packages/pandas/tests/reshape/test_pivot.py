...
class TestPivotTable:
    ...
    def test_pivot_table_categorical(self):
        ...
        result = pivot_table(df, values="values", index=[
                             "A", "B"], dropna=True)
    ...
    def test_pivot_table_dropna_categoricals(self, dropna):
        ...
        result = df.pivot_table(index="B", columns="A",
                                values="C", dropna=dropna)
    ...
    def test_pivot_with_interval_index(self, interval_values, dropna):
        ...
        result = df.pivot_table(index="A", values="B", dropna=dropna)
        expected = DataFrame({"B": 1}, index=Index(
            interval_values.unique(), name="A"))
        if not dropna:
    ...
    def test_pivot_index_with_nan(self, method):
        ...
        tm.assert_frame_equal(
            df.pivot(index="b", columns="a", values="c"), expected.T)
    ...
    def test_pivot_tz_in_values(self):
        ...
        mins = df.ts.map(lambda x: x.replace(
    ...
    def test_pivot_periods_with_margins(self):
        ...
        result = df.pivot_table(index="a", columns="b",
                                values="x", margins=True)
    ...
    def test_pivot_table_margins_name_with_aggfunc_list(self):
        ...
        ix = Index(["bacon", "cheese", margins_name],
    ...
    def test_pivot_table_not_series(self):
        ...
        result = df.pivot_table("col1", index="col3",
    ...
    def test_pivot_number_of_levels_larger_than_int32(self, monkeypatch):
        ...
        with monkeypatch.context() as m:
            ...
            df = DataFrame(
                {"ind1": np.arange(
                    2**16), "ind2": np.arange(2**16), "count": 0}
            )
    ...
    def test_pivot_table_empty_aggfunc(self, margins):
        ...
        expected = DataFrame(index=Index(
            [], dtype="int64", name="A"), columns=exp_cols)
        tm.assert_frame_equal(result, expected)
