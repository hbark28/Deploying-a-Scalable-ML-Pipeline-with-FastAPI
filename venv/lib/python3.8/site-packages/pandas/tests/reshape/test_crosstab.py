...
class TestCrosstab:
    ...
    def test_crosstab_normalize(self):
        ...
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize="all"), full_normal)
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize=True), full_normal)
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize="index"), row_normal)
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize="columns"), col_normal)
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize=1),
            crosstab(df.a, df.b, normalize="columns"),
        )
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize=0), crosstab(
    ...
    def test_crosstab_with_empties(self, using_array_manager):
        ...
        for i in [True, "index", "columns"]:
            calculated = crosstab(df.a, df.b, values=df.c,
                                  aggfunc="count", normalize=i)
    ...
    def test_crosstab_with_numpy_size(self):
        ...
        expected_column = Index(["bar", "foo", "All"],
                                dtype="object", name="C")
