...
class TestSeriesDatetimeValues:
    ...
    def test_dt_namespace_accessor_datetime64tz(self):
        ...
        expected = Series(ser._values.tz_convert(
            "CET"), index=ser.index, name="xxx")
        tm.assert_series_equal(result, expected)
    ...
    def test_dt_namespace_accessor_timedelta(self):
        ...
        cases = [
            ...
            Series(timedelta_range("1 day 01:23:45",
                   periods=5, freq="s"), name="xxx"),
            Series(
                timedelta_range("2 days 01:23:45.012345",
                                periods=5, freq="ms"),
                name="xxx",
            ),
        ]
    ...
    def test_dt_accessor_limited_display_api(self):
        ...
        ser = Series(date_range(
            "2015-01-01", "2016-01-01", freq="T"), name="xxx")
    ...
    @pytest.mark.parametrize(
        "ser", [Series(np.arange(5)), Series(
            list("abcde")), Series(np.random.randn(5))]
    )
