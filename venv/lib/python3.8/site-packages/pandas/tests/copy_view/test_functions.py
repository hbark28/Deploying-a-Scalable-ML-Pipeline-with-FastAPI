...
def test_concat_frames(using_copy_on_write):
    ...
    if using_copy_on_write:
        ...
        assert not np.shares_memory(
            get_array(result, "a"), get_array(df2, "a"))
...
def test_concat_frames_chained(using_copy_on_write):
    ...
    if using_copy_on_write:
        ...
        assert not np.shares_memory(
            get_array(result, "a"), get_array(df1, "a"))
        assert not np.shares_memory(
            get_array(result, "c"), get_array(df2, "c"))
        assert not np.shares_memory(
            get_array(result, "d"), get_array(df3, "d"))
...
def test_concat_series_chained(using_copy_on_write):
    ...
    if using_copy_on_write:
        ...
        assert not np.shares_memory(
            get_array(result, "a"), get_array(ser1, "a"))
        assert not np.shares_memory(
            get_array(result, "c"), get_array(ser2, "c"))
        assert not np.shares_memory(
            get_array(result, "d"), get_array(ser3, "d"))
...
def test_concat_series_updating_input(using_copy_on_write):
    ...
    if using_copy_on_write:
        ...
        assert not np.shares_memory(
            get_array(result, "a"), get_array(ser, "a"))
        assert not np.shares_memory(
            get_array(result, "b"), get_array(ser2, "b"))
...
def test_concat_mixed_series_frame(using_copy_on_write):
    ...
    if using_copy_on_write:
        ...
        assert not np.shares_memory(
            get_array(result, "d"), get_array(ser, "d"))
...
def test_concat_copy_keyword(using_copy_on_write, copy):
    ...
    if using_copy_on_write or copy is False:
        ...
        assert not np.shares_memory(
            get_array(df2, "b"), get_array(result, "b"))
...
def test_merge_on_key(using_copy_on_write, func):
    ...
    if using_copy_on_write:
        ...
        assert not np.shares_memory(
            get_array(result, "a"), get_array(df1, "a"))
        assert not np.shares_memory(
            get_array(result, "b"), get_array(df2, "b"))
