...
class TestGroupBy:
    ...
    def test_timegrouper_with_reg_groups(self):
        ...
        for df in [df_original, df_sorted]:
            ...
            result = df.groupby([Grouper(freq="A"), "Buyer"]
    ...
    def test_timegrouper_apply_return_type_series(self):
        ...
        result = df_dt.groupby(
            Grouper(freq="M", key="date")).apply(sumfunc_series)
    ...
    def test_timegrouper_apply_return_type_value(self):
        ...
        result = df_dt.groupby(
            Grouper(freq="M", key="date")).apply(sumfunc_value)
    ...
    def test_groupby_groups_datetimeindex(self):
        ...
        for date in dates:
            ...
            expected = DataFrame(data, columns=list("AB"),
...
4,2000-01-01 16:50:00,America/New_York"""
    ...
    def test_datetime_count(self):
        df = DataFrame(
            {"a": [1, 2, 3] * 2,
                "dates": date_range("now", periods=6, freq="T")}
        )
