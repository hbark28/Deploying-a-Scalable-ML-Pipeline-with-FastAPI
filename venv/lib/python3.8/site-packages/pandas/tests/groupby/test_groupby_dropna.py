...
def test_groupby_dropna_normal_index_dataframe(dropna, idx, outputs):
    ...
    expected = pd.DataFrame(outputs, index=pd.Index(
...
def test_categorical_transformers(
    ...
    if transformation_func == "cumcount":
        ...
        null_group_data = getattr(
            null_group_values, transformation_func)(*args)
...
def test_categorical_head_tail(method, observed, sort, as_index):
    ...
    gb = df.groupby("x", dropna=False, observed=observed,
                    sort=sort, as_index=as_index)
