...
class TestDataFrameRound:
    def test_round(self):
        ...
        expected_rounded = DataFrame(
            {"col1": [1.0, 2.0, 3.0], "col2": [1.0, 2.0, 3.0]})
        ...
        tm.assert_frame_equal(big_df.round(
            negative_round_dict), expected_neg_rounded)
        ...
        tm.assert_series_equal(df["col1"].round(
            decimals), expected_rounded["col1"])
        tm.assert_series_equal(
            df.round(decimals)["col1"], expected_rounded["col1"])
