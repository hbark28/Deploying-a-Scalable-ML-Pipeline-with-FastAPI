...
class TestDataFrameIndexing:
    ...
    def test_setitem_list2(self):
        df = DataFrame(0, index=range(3), columns=[
                       "tt1", "tt2"], dtype=np.int_)
    ...
    def test_setitem_boolean(self, float_frame):
        ...
        expected = DataFrame(values, index=df_orig.index,
    ...
    def test_setitem_None(self, float_frame):
        ...
        tm.assert_series_equal(
            float_frame[None], float_frame["A"], check_names=False)
        repr(float_frame)
    ...
    def test_getitem_setitem_ix_duplicates(self):
        # #1201
        df = DataFrame(np.random.randn(5, 3), index=[
                       "foo", "foo", "bar", "baz", "bar"])
    ...
    def test_loc_duplicates(self):
        ...
        trange = trange.insert(
            loc=5, item=Timestamp(year=2017, month=1, day=5))
    ...
    def test_setitem_with_unaligned_tz_aware_datetime_column(self):
        ...
        column = Series(date_range(
            "2015-01-01", periods=3, tz="utc"), name="dates")
