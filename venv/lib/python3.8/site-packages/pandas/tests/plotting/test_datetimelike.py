...
class TestTSPlot(TestPlotBase):
    ...
    def test_get_datevalue(self):
        ...
        assert get_datevalue(Period(1987, "A"), "M") == Period(
            "1987-12", "M").ordinal
        assert get_datevalue(
            "1/1/1987", "D") == Period("1987-1-1", "D").ordinal
    ...
    def test_ts_plot_format_coord(self):
        ...
        annual = Series(1, index=date_range(
            "2014-01-01", periods=3, freq="A-DEC"))
        _, ax = self.plt.subplots()
        annual.plot(ax=ax)
    ...
    def test_line_plot_period_frame(self, freq):
        idx = date_range("12/31/1999", freq=freq, periods=100)
        df = DataFrame(np.random.randn(len(idx), 3),
    ...
    def test_mixed_freq_shared_ax(self):
        ...
        )[0, 0] == ax2.lines[0].get_xydata()[0, 0]
    ...
    def test_add_matplotlib_datetime64(self):
        ...
        s = Series(np.random.randn(10), index=date_range(
            "1970-01-02", periods=10))
        ax = s.plot()
    ...
    def test_matplotlib_scatter_datetime64(self):
        ...
        df = DataFrame(np.random.RandomState(
            0).rand(10, 2), columns=["x", "y"])
