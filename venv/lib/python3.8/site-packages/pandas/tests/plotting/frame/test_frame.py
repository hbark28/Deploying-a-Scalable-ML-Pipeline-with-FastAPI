...
class TestDataFramePlots(TestPlotBase):
    ...
    def test_plot(self):
        ...
        _check_plot_works(df.plot, default_axes=True,
    ...
    def test_plot_xy(self):
        ...
        self._check_axes_shape(
            ax, axes_num=1, layout=(1, 1), figsize=(16.0, 8.0))
    ...
    def test_line_area_nan_df(self):
        ...
        tdf = DataFrame({"a": values1, "b": values2},
    ...
    def test_scatterplot_color_by_categorical(self, ordered, categories):
        ...
        assert all(i == j for i, j in zip(
            result_yticklabels, expected_yticklabels))
    ...
    def test_plot_scatter_with_s(self):
        ...
        df = DataFrame(np.random.random((10, 3)) *
                       100, columns=["a", "b", "c"])
    ...
    def test_hist_weights(self, weights):
        ...
        patch_height_with_weights = [patch.get_height()
    ...
    def test_errorbar_plot_iterator(self):
        with warnings.catch_warnings():
            ...
            # yerr is iterator
            ax = _check_plot_works(
                df.plot, yerr=itertools.repeat(0.1, len(df)))
            self._check_has_errorbars(ax, xerr=0, yerr=2)
    ...
    def test_errorbar_scatter(self):
        ...
        self._check_has_errorbars(ax, xerr=0, yerr=1)
        ax = _check_plot_works(df.plot.scatter, x="x",
                               y="y", xerr=df_err, yerr=df_err)
        self._check_has_errorbars(ax, xerr=1, yerr=1)

        def _check_errorbar_color(containers, expected, has_err="has_xerr"):
            lines = []
            errs = [c.lines for c in ax.containers if getattr(
                c, has_err, False)][0]
            for el in errs:
                if is_list_like(el):
                    lines.extend(el)
