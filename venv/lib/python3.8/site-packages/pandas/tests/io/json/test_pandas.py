...
class TestPandasContainer:
    ...
    def test_blocks_compat_GH9037(self):
        ...
        df_roundtrip = read_json(df_mixed.to_json(
    ...
    def test_series_non_unique_index(self):
        ...
        tm.assert_series_equal(
            s, read_json(s.to_json(orient="split"),
    ...
    def test_round_trip_exception_(self, datapath):
        ...
        s = df.to_json()
        result = read_json(s)
        tm.assert_frame_equal(result.reindex(
    ...
    def test_timedelta(self):
        ...
        tm.assert_frame_equal(frame, read_json(
            frame.to_json()).apply(converter))
    ...
    def test_datetime_tz(self):
        ...
        df = DataFrame(
            {"A": tz_range, "B": pd.date_range("20130101", periods=3)})
    ...
    def test_read_timezone_information(self):
        ...
        expected = Series([88], index=DatetimeIndex(
            ["2019-01-01 11:00:00"], tz="UTC"))
        tm.assert_series_equal(result, expected)
...
{spaces}}}
    ...
    def test_read_json_nullable_series(self, string_storage, dtype_backend, orient):
        ...
        if dtype_backend == "pyarrow":
            ...
            expected = Series(ArrowExtensionArray(
                pa.array(expected, from_pandas=True)))
