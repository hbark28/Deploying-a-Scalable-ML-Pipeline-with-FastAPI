...
class TestStata:
    ...
    def test_read_dta1(self, file, datapath):
        ...
        expected = DataFrame(
            ...
            columns=["float_miss", "double_miss",
                     "byte_miss", "int_miss", "long_miss"],
        )
    ...
    def test_read_dta12(self, datapath):
        parsed_117 = self.read_dta(
            datapath("io", "data", "stata", "stata12_117.dta"))
        expected = DataFrame.from_records(
            [
                [1, "abc", "abcdefghi"],
    ...
    def test_read_dta18(self, datapath):
        parsed_118 = self.read_dta(
            datapath("io", "data", "stata", "stata14_118.dta"))
    ...
    def test_read_write_dta10(self, version):
        ...
        with tm.ensure_clean() as path:
            original.to_stata(path, convert_dates={
    ...
    def test_read_write_reread_dta14(self, file, parsed_114, version, datapath):
        ...
        with tm.ensure_clean() as path:
            parsed_114.to_stata(path, convert_dates={
        ...
        for col in expected:
            if is_categorical_dtype(expected[col].dtype):
                tm.assert_series_equal(
                    expected[col].cat.codes, parsed[col].cat.codes)
...
"""
    ...
    def test_unicode_dta_118(self, datapath):
        unicode_df = self.read_dta(
            datapath("io", "data", "stata", "stata16_118.dta"))
...
the string values returned are correct."""
    ...
    def test_stata_119(self, datapath):
        ...
        assert df.iloc[0, 0] == pd.Timestamp(
            datetime(2012, 12, 21, 21, 12, 21))
