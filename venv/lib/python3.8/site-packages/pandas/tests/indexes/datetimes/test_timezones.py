...
class TestDatetimeIndexTimezones:
    ...
    def test_dti_tz_localize_nonexistent_raise_coerce(self):
        ...
        test_times = ["2015-03-08 01:00-05:00",
                      "NaT", "2015-03-08 03:00-04:00"]
    ...
    def test_dti_tz_localize_ambiguous_infer(self, tz):
        ...
        dr = date_range(datetime(2011, 11, 6, 0),
                        periods=5, freq=pd.offsets.Hour())
        ...
        tm.assert_index_equal(expected, DatetimeIndex(
            times, tz=tz, ambiguous="infer"))

        # When there is no dst transition, nothing special happens
        dr = date_range(datetime(2011, 6, 1, 0),
                        periods=10, freq=pd.offsets.Hour())
    ...
    def test_dti_tz_localize_ambiguous_times(self, tz):
        ...
        dr = date_range(datetime(2011, 3, 13, 1, 30),
                        periods=3, freq=pd.offsets.Hour())
    ...
    def test_dti_tz_localize(self, prefix):
        ...
        dti = date_range(start="1/1/2005",
                         end="1/1/2005 0:00:30.256", freq="L")
        ...
        dti = date_range(start="11/6/2011 1:59",
                         end="11/6/2011 2:00", freq="L")
        with pytest.raises(pytz.AmbiguousTimeError, match="Cannot infer dst time"):
            dti.tz_localize(tzstr)

        dti = date_range(start="3/13/2011 1:59",
                         end="3/13/2011 2:00", freq="L")
    ...
    def test_normalize_tz(self):
        rng = date_range("1/1/2000 9:30", periods=10,
    ...
    def test_dti_construction_univalent(self):
        rng = date_range("03/12/2012 00:00", periods=10,
    ...
    def test_dti_tz_constructors(self, tzstr):
        ...
        idx2 = date_range(start="2005-11-10 08:00:00",
                          freq="H", periods=2, tz=tzstr)
    ...
    def test_date_range_localize(self):
        rng = date_range("3/11/2012 03:00", periods=15,
                         freq="H", tz="US/Eastern")
        rng2 = DatetimeIndex(
            ["3/11/2012 03:00", "3/11/2012 04:00"], tz="US/Eastern")
        ...
        rng = date_range("3/11/2012 00:00", periods=10,
                         freq="H", tz="US/Eastern")
        assert rng[2].hour == 3
    ...
    def test_with_tz(self, tz):
        ...
        dr = bdate_range(
            datetime(2005, 1, 1, tzinfo=pytz.utc), datetime(
    ...
    def test_dti_convert_tz_aware_datetime_datetime(self, tz):
        # GH#1581
        dates = [datetime(2000, 1, 1), datetime(
