...
def period_index(freqstr):
    ...
    pi = pd.period_range(start=Timestamp("2000-01-01"),
...
class SharedTests:
    ...
    def test_concat_same_type(self, arr1d):
        ...
        expected = self.index_cls(np.concatenate(
            [arr2[:-1], arr2[1:], arr2]), None)
...
class TestDatetimeArray(SharedTests):
    ...
    def test_concat_same_type_different_freq(self):
        ...
        a = DatetimeArray(pd.date_range(
            "2000", periods=2, freq="D", tz="US/Central"))
        b = DatetimeArray(pd.date_range(
            "2000", periods=2, freq="H", tz="US/Central"))
