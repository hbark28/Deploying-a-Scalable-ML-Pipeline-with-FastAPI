...
""",
    ...
    def combine(
        ...
        res_values = maybe_cast_pointwise_result(
            npvalues, self.dtype, same_dtype=False)
    ...
    def sort_values(
        ...
        *,
        ...
        values_to_sort = ensure_key_mapped(
            self, key)._values if key else self._values
    ...
    def aggregate(self, func=None, axis: Axis = 0, *args, **kwargs):
        ...
        op = SeriesApply(self, func, convert_dtype=False,
