...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def squeeze(self, axis: Axis | None = None):
        ...
        1
        """
        axes = range(self._AXIS_LEN) if axis is None else (
    ...
    def _clip_with_one_bound(self, threshold, method, axis, inplace):
        ...
        if (not isinstance(threshold, ABCSeries)) and is_list_like(threshold):
            if isinstance(self, ABCSeries):
                ...
                threshold = align_method_FRAME(
                    self, threshold, axis, flex=None)[1]
    ...
    def _where(
        ...
        if isinstance(cond, NDFrame):
            ...
            cond = cond.align(self, join="right",
                              broadcast_axis=1, copy=False)[0]
        else:
    ...
    def pct_change(
        self: NDFrameT,
        periods: int = 1,
        fill_method: Literal["backfill", "bfill",
                             "pad", "ffill"] | None = "pad",
        limit=None,
        freq=None,
        **kwargs,
    ...
    def _find_valid_index(self, *, how: str) -> Hashable | None:
        ...
        """
        idxpos = find_valid_index(
            self._values, how=how, is_valid=~isna(self._values))
        if idxpos is None:
            return None
