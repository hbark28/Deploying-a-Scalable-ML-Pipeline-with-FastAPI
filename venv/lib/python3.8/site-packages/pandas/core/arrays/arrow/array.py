...
ArrowExtensionArrayT = TypeVar(
    "ArrowExtensionArrayT", bound="ArrowExtensionArray")
...
class ArrowExtensionArray(
        ...
        if (
            ...
            and (
                pa.types.is_large_binary(
                    pa_dtype) or pa.types.is_large_string(pa_dtype)
            )
        ):
    ...
    def argsort(
        ...
        **kwargs,
        ...
        null_placement = {"last": "at_end",
                          "first": "at_start"}.get(na_position, None)
    ...
    def isin(self, values) -> npt.NDArray[np.bool_]:
        ...
        result = pc.is_in(self._data, value_set=pa.array(
    ...
    def factorize(
        ...
        if encoded.length() == 0:
            ...
            uniques = type(self)(pa.chunked_array(
    ...
    def _str_replace(
        ...
        result = func(self._data, pattern=pat,
    ...
    def _str_repeat(self, repeats: int | Sequence[int]):
        if not isinstance(repeats, int):
            ...
            raise NotImplementedError(
                "repeat is not implemented for pyarrow < 7")
        else:
    ...
    def _dt_to_pydatetime(self):
        ...
        if self._dtype.pyarrow_dtype.unit == "ns":
            data = [None if ts is None else ts.to_pydatetime(
