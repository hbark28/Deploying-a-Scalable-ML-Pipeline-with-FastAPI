...
class DataFrame(NDFrame, OpsMixin):
    ...
    def __init__(
        ...
        if isinstance(data, (BlockManager, ArrayManager)):
            ...
            mgr = dict_to_mgr(data, index, columns,
        ...
        # For data is scalar
            ...
            if isinstance(dtype, ExtensionDtype):
                ...
                mgr = arrays_to_mgr(values, columns, index,
                                    dtype=None, typ=manager)
            else:
    ...
    def _values(self) -> np.ndarray | DatetimeArray | TimedeltaArray | PeriodArray:
        ...
        arr = cast(
            "np.ndarray | DatetimeArray | TimedeltaArray | PeriodArray", arr)
        return arr.T
    ...
    def transpose(self, *args, copy: bool = False) -> DataFrame:
        ...
        **Non-square DataFrame with mixed dtypes**
        ...
        if self._can_fast_transpose:
            ...
            self._is_homogeneous_type and dtypes and is_extension_array_dtype(
                dtypes[0])
        ):
            ...
            new_values = [arr_type._from_sequence(
                row, dtype=dtype) for row in values]
    ...
    def _ixs(self, i: int, axis: AxisInt = 0) -> Series:
        ...
        if axis == 0:
            ...
            copy = isinstance(
                new_mgr.array, np.ndarray) and new_mgr.array.base is None
    ...
    def _cmp_method(self, other, op):
        ...
        self, other = ops.align_method_FRAME(
            self, other, axis, flex=False, level=None)
    ...
    def _arith_method(self, other, op):
        ...
        self, other = ops.align_method_FRAME(
            self, other, axis, flex=True, level=None)
    ...
    def round(
        ...
        **kwargs
        ...
        if isinstance(decimals, (dict, Series)):
            ...
            return self._constructor(
                self._mgr.round(decimals=decimals,
                                using_cow=using_copy_on_write()),
    ...
    def quantile(
        ...
        if method == "single":
            ...
            if len(by) > 1:
                ...
                by = by[0]
                k = data._get_label_or_level_values(
