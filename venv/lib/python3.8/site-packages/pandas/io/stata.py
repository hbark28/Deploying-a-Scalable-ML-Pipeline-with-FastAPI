...
def _cast_to_stata_types(data: DataFrame) -> DataFrame:
    ...
    for col in data:
        ...
        is_nullable_int = isinstance(
            data[col].dtype, (IntegerDtype, BooleanDtype))
        orig = data[col]
...
class StataParser:
    def __init__(self) -> None:
        ...
        self.DTYPE_MAP = dict(
            list(zip(range(1, 245), [np.dtype("a" + str(i))
...
class StataReader(StataParser, abc.Iterator):
    ...
    def _read_header(self) -> None:
        ...
        self._has_string_data = len(
            [x for x in self._typlist if type(x) is int]) > 0
    ...
    def _read_new_header(self) -> None:
        ...
        if self._format_version not in [117, 118, 119]:
            raise ValueError(_version_error.format(
