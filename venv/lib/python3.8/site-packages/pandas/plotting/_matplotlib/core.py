...
class MPLPlot(ABC):
    ...
    def __init__(
        ...
        **kwds,
        ...
        self.ax = ax
        self.fig = fig
        # "real" version get set in `generate`
    ...
    def __init__(self, data, x, y, **kwargs) -> None:
        ...
        if self._kind == "hexbin":
            if len(self.data[x]._get_numeric_data()) == 0:
                raise ValueError(
                    self._kind + " requires x column to be numeric")
            if len(self.data[y]._get_numeric_data()) == 0:
                raise ValueError(
                    self._kind + " requires y column to be numeric")
...
class ScatterPlot(PlanePlot):
    ...
    def _make_plot(self):
        ...
        color_by_categorical = c_is_column and is_categorical_dtype(
            self.data[c])
        ...
        cb = self.kwds.pop("colorbar", is_numeric_dtype(
            c_values) and plot_colorbar)
