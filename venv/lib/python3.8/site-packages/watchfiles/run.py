    ...
    try:
        for changes in watch(
            *paths,
            ...
            process.stop(sigint_timeout=sigint_timeout,
...
def start_process(
    ...
    if target_type == 'function':
        ...
        assert isinstance(
            target, str), 'target must be a string to run as a command'
...
def raise_keyboard_interrupt(signum: int, _frame: Any) -> None:  # pragma: no cover
    logger.warning('received signal %s, raising KeyboardInterrupt',
